...
(function () {
  ...
  function hb(k) {
    if (!ib) {
      ...
      if (k.creditHref && k.creditText) {
        ...
        if (0 === k.renderCount || m || v) k._creditLink.setAttribute('href', k.creditHref),
  ...
  function Ka() {
    for (var k = null, m = 0; m < arguments.length; m++) k = arguments[m],
  ...
  fa = function (k, m, v) {
    ...
    E = m.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
    m = null;
    for (var L = 0; E && L < E.length; L++) if (m = E[L], '.' === m && 0 > Q) Q = L;
     else {
      if ('%' === m) D *= 100;
       else if ('‰' === m) {
        D *= 1000;
    ...
    k = (m[1] + '').split('');
    D && '0' === D[0] && D.shift();
    for (T = E = L = I = Q = 0; 0 < N.length; ) if (m = N.pop(), '#' === m || '0' === m) if (Q++, Q === S) {
      var Y = D,
      D = [
      ];
      if ('0' === m) for (m = S - I - (Y ? Y.length : 0); 0 < m; ) Y.unshift('0'),
      m--;
      for (; 0 < Y.length; ) v = Y.pop() + v,
      T++,
      0 === T % E && (L === W && 0 < Y.length) && (v = w + v)
    } else 0 < D.length ? (v = D.pop() + v, I++, T++) : '0' === m && (v = '0' + v, I++, T++),
    ...
    w = '';
    for (N = !1; 0 < G.length; ) m = G.shift(),
    '#' === m || '0' === m ? 0 < k.length && 0 !== Number(k.join('')) ? (w += k.shift(), N = !0) : '0' === m && (w += '0', N = !0) : 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || '\'' === m[0] && '\'' === m[m.length - 1]) ? w += m.slice(1, m.length - 1) : 'E' !== m[0] && 'e' !== m[0] || '0' !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? w += m : (m = 0 > X ? m.replace('+', '').replace('-', '') : m.replace('-', ''), w += m.replace(/[0]+/, function (a) {
      return aa(X, a.length)
    }));
    v += (N ? s : '') + w;
    return r ? '-' + v : v
  ...
  da = function (k, m, v, r, s, w, D, E, Q, N, T, S, G) {
    ...
    !0 === S && (k.save(), k.beginPath(), k.moveTo(r, v), k.lineTo(r - I, v + I), k.lineTo(r - I, s - I), k.lineTo(r, s), D = k.createLinearGradient(r - I, (s + v) / 2, r, (s + v) / 2), D.addColorStop(0, w), D.addColorStop(1, 'rgba(255, 255, 255, 0.1)'), k.fillStyle = D, D.addColorStop(0, w), D.addColorStop(1, 'rgba(255, 255, 255, 0.1)'), k.fillStyle = D, k.fill(), k.closePath(), k.restore())
  },
  Z = function (k) {
    for (var m = '', r = 0; r < k.length; r++) m += String.fromCharCode(Math.ceil(k.length / 57 / 5) ^ k.charCodeAt(r));
    return m
  },
  bb = window && window[Z('mnb`uhno')] && window[Z('mnb`uhno')].href && window[Z('mnb`uhno')].href.indexOf && ( - 1 !== window[Z('mnb`uhno')].href.indexOf(Z('b`ow`rkr/bnl')) || - 1 !== window[Z('mnb`uhno')].href.indexOf(Z('gdonqhy/bnl')) || - 1 !== window[Z('mnb`uhno')].href.indexOf(Z('gheemd'))),
  ...
  X.prototype.set = function (k, m, r) {
    ...
    if ('options' === k) this.createUserOptions(m);
     else if (s.hasOwnProperty(k) || s.publicProperties && s.publicProperties.hasOwnProperty(k) && 'readWrite' === s.publicProperties[k]) this.options._isPlaceholder && this.createUserOptions(),
    this.options[k] = m;
     else {
  ...
  X.prototype.createUserOptions = function (k) {
    if ('undefined' !== typeof k || this.options._isPlaceholder) if (this.parent.options._isPlaceholder && this.parent.createUserOptions(), this.isOptionsInArray) {
      ...
      this.options = 'undefined' === typeof k ? {
      }
       : k;
      m[r] = this.options
    } else this.options = 'undefined' === typeof k ? {
    }
     : k,
  ...
  w = Oa.Chart = function () {
    ...
    function m(a, d, c) {
      ...
      r(c) ? (this.predefinedThemes = ab, this.optionsName = this.parent = this.index = null) : (this.parent = c.parent, this.index = c.index, this.predefinedThemes = c.predefinedThemes, this.optionsName = c.optionsName, this.stockChart = c.stockChart, this.panel = a, this.isOptionsInArray = c.isOptionsInArray);
      ...
      'touchstart', function (a) {
        ...
        b._touchEventHandler(a)
      }, this.allDOMEventHandlers), this.toolTip = new aa(this, this.options.toolTip), this.data = null, this.axisX = [
      ], this.axisX2 = [
      ], this.axisY = [
      ], this.axisY2 = [
    ...
    function D(a, d, c, b, e, f) {
      ...
      }), this.sessionVariables = this.chart.sessionVariables.axisX2[b]), this.options.interval || (this.intervalType = null)) : 'left' ===
      f || 'bottom' === f ? (this.optionsName = 'axisY', r(this.chart.sessionVariables.axisY[b]) && (this.chart.sessionVariables.axisY[b] = {
    ...
    function U(a, d, c, b) {
      ...
      if (this.options.customBreaks && 0 < this.options.customBreaks.length) {
        for (a = 0; a < this.options.customBreaks.length; a++) this.customBreaks.push(new V(this.chart, 'customBreaks', this.options.customBreaks[a], a, ++this.chart._eventManager.lastObjectId, this)),
    ...
    m.prototype._initialize = function () {
      ...
      if (this.options.data) {
        ...
        this.options.data.length; c++) if (a++, !this.options.data[c].type || 0 <= m._supportedChartTypes.indexOf(this.options.data[c].type)) {
          ...
          ], b.color = this._selectedColorSet[b.index % this._selectedColorSet.length]) : b._colorSet = 'line' === b.type || 'stepLine' === b.type || 'spline' === b.type || 'area' === b.type || 'stepArea' === b.type || 'splineArea' === b.type || 'stackedArea' === b.type || 'stackedArea100' === b.type || 'rangeArea' === b.type || 'rangeSplineArea' === b.type || 'candlestick' ===
          b.type || 'ohlc' === b.type || 'waterfall' === b.type || 'boxAndWhisker' === b.type ? [
            this._selectedColorSet[0]
          ] : this._selectedColorSet : b._colorSet = [
            b.color
          ];
    ...
    m.prototype.setLayout = function () {
      for (var a = this._plotAreaElements, d = 0; d < this.data.length; d++) if ('normal' === this.plotInfo.axisPlacement || 'xySwapped' === this.plotInfo.axisPlacement) {
        ...
        this._axes.push(this.axisX[0] = new D(this, 'axisX', this.options.axisX, 0, 'axisX', 'bottom')) : 'xySwapped' === this.plotInfo.axisPlacement && this._axes.push(this.axisX[0] = new D(this, 'axisX', this.options.axisX, 0, 'axisX', 'left'))),
        ...
        this.plotInfo.axisPlacement ? this._axes.push(this.axisX2[0] = new D(this, 'axisX2', this.options.axisX2, 0, 'axisX', 'top')) : 'xySwapped' === this.plotInfo.axisPlacement && this._axes.push(this.axisX2[0] = new D(this, 'axisX2', this.options.axisX2, 0, 'axisX', 'right'))),
      ...
      if (this.options.subtitles) for (d = 0; d < this.options.subtitles.length; d++) c = new Ha(this, this.options.subtitles[d], d),
    ...
    m.prototype.renderElements = function () {
      ...
      var p = this;
      if (0 < c.length) p.disableToolTip = !0,
      p._animator.animate(200, p.animationDuration, function (a) {
        ...
        1 > a && 'undefined' !== typeof z.startTimePercent ? a >= z.startTimePercent && z.animationCallback(z.easingFunction(a - z.startTimePercent, 0, 1, 1 - z.startTimePercent), z) : z.animationCallback(z.easingFunction(a, 0, 1, 1), z);
        ...
        if (p._breaksCanvas) if (s) p.plotArea.ctx.drawImage(p._breaksCanvas, 0, 0, this.width, this.height);
    ...
    m.prototype._processStackedPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        ...
        ], z = Infinity, h = - Infinity, p = 0; p < a.dataSeriesIndexes.length; p++) {
        ...
        for (q in u) u.hasOwnProperty(q) && !isNaN(q) && (a = u[q], a < d.min && (d.min = a), a > d.max && (d.max = Math.max(a, h)), q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = a), a > d.viewPortMax && (d.viewPortMax = Math.max(a, h))))
      }
    };
    m.prototype._processStacked100PlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = !1, u = !1, z = [
        ], h = 0; h < a.dataSeriesIndexes.length; h++) {
          var p = this.data[a.dataSeriesIndexes[h]],
          n = 0,
          q = !1,
          g = !1,
          A;
          if ('normal' === p.axisPlacement || 'xySwapped' === p.axisPlacement) var k = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : - Infinity,
          ...
          for (n = 0; n < p.dataPoints.length; n++) {
            ...
            if (0 < n) {
              ...
              } else t = b - p.dataPoints[n - 1].x,
              0 > t && (t *= - 1),
              c.minDiff > t && 0 !== t && (c.minDiff = t);
              r(e) || null === p.dataPoints[n - 1].y || (a.axisY.logarithmic ? 0 < e && (t = e / p.dataPoints[n - 1].y, 1 > t && (t = 1 / t), d.minDiff > t && 1 !== t && (d.minDiff = t)) : (t = e - p.dataPoints[n - 1].y, 0 > t && (t *= - 1), d.minDiff > t && 0 !== t && (d.minDiff = t)))
            }
            if (b < k && !q) null !== e && (A = b);
             else {
              if (!q && (q = !0, 0 < n)) {
    ...
    m.prototype._processMultiYPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, l, u = !1, z = 0; z < a.dataSeriesIndexes.length; z++) {
        ...
        A,
        k;
        if ('normal' === h.axisPlacement || 'xySwapped' === h.axisPlacement) var m = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : a.axisX.logarithmic ? 0 : - Infinity,
    ...
    m.prototype._processSpecificPlotUnit = function (a) {
      if ('waterfall' === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
        ...
        g = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity;
        if (u.dataPoints[z].x && u.dataPoints[z].x.getTime || 'dateTime' === u.xValueType) f = !0;
        for (z = 0; z < u.dataPoints.length; z++) 'undefined' !== typeof u.dataPoints[z].isCumulativeSum && !0 === u.dataPoints[z].isCumulativeSum ? (u.dataPointEOs[z].cumulativeSumYStartValue = 0, u.dataPointEOs[z].cumulativeSum = 0 === z ? 0 : u.dataPointEOs[z - 1].cumulativeSum, u.dataPoints[z].y = 0 === z ? 0 : u.dataPointEOs[z - 1].cumulativeSum) : 'undefined' !== typeof u.dataPoints[z].isIntermediateSum && !0 === u.dataPoints[z].isIntermediateSum ? (u.dataPointEOs[z].cumulativeSumYStartValue = n, u.dataPointEOs[z].cumulativeSum = 0 === z ? 0 : u.dataPointEOs[z - 1].cumulativeSum, u.dataPoints[z].y = 0 === z ? 0 : b, n = 0 === z ? 0 : u.dataPointEOs[z - 1].cumulativeSum, b = 0) : (e = 'number' !== typeof u.dataPoints[z].y ? 0 : u.dataPoints[z].y, u.dataPointEOs[z].cumulativeSumYStartValue = 0 === z ? 0 : u.dataPointEOs[z - 1].cumulativeSum, u.dataPointEOs[z].cumulativeSum = 0 === z ? e : u.dataPointEOs[z - 1].cumulativeSum + e, b += e);
    ...
    m.prototype.calculateAutoBreaks = function () {
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
          ...
          if (b || c) for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, h = f.min, l = f.max, p = d.min, q = d.max, f = f._dataRanges, d = d._dataRanges, n, u = 0, z = 0; z < a.dataSeriesIndexes.length; z++) {
            ...
            if (!(4 > k.dataPoints.length)) for (u = 0; u < k.dataPoints.length; u++) if (b && (n = (l + 1 - h) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, g = k.dataPoints[u].x.getTime ? k.dataPoints[u].x.getTime() : k.dataPoints[u].x, n = Math.floor((g - h) / n), g < f[n].min && (f[n].min = g), g > f[n].max && (f[n].max = g)), c) {
              ...
              if ((g = 'waterfall' === a.type ? k.dataPointEOs[u].cumulativeSum : k.dataPoints[u].y) && g.length) for (var s = 0; s < g.length; s++) n = Math.floor((g[s] - p) / m),
      ...
      function c(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks) for (var b = a.axisX.dataInfo, c = b.min, d = b.max, f = b._dataRanges, g, h = 0, l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          if (!(4 > p.dataPoints.length)) for (h = 0; h < p.dataPoints.length; h++) g = (d + 1 - c) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100,
      ...
      if (f) {
        for (l = 0; l < this.plotInfo.plotTypes.length; l++) for (f = this.plotInfo.plotTypes[l], u = 0; u < f.plotUnits.length; u++) b = f.plotUnits[u],
        'line' === b.type || 'stepLine' === b.type || 'spline' === b.type || 'column' === b.type || 'area' === b.type || 'stepArea' === b.type || 'splineArea' === b.type || 'bar' === b.type || 'bubble' === b.type || 'scatter' === b.type || 'candlestick' === b.type || 'ohlc' === b.type || 'rangeColumn' === b.type || 'rangeBar' === b.type || 'rangeArea' ===
    ...
    m.prototype._mouseEventHandler = function (a) {
      ...
      if (this.interactivityEnabled) if (this._ignoreNextEvent) this._ignoreNextEvent = !1;
       else if (a.preventManipulation && a.preventManipulation(), a.preventDefault && a.preventDefault(), Ga && window.console && (window.console.log(c + ' --> x: ' + d.x + '; y:' + d.y), e && window.console.log(a.which), 'mouseup' === c && window.console.log('mouseup')), !e) {
    ...
    m.prototype.validateRegion = function (a, d, c, b, e) {
      e = e || !1;
      for (var f = 0 <= this.zoomType.indexOf('x'), l = 0 <= this.zoomType.indexOf('y'), u = !1, z = [
      ], h = [
      ], p = [
      ], n = 0; n < this._axes.length; n++) ('axisX' === this._axes[n].type && f || 'axisY' === this._axes[n].type && l) && h.push(this._axes[n]);
      for (l = 0; l < h.length; l++) {
        ...
        if (isFinite(n.dataInfo.minDiff)) if (A = n.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && n.scaleBreaks && n.scaleBreaks._appliedBreaks.length) && (n.logarithmic && A < Math.pow(n.dataInfo.minDiff, 3) || !n.logarithmic && A < 3 * Math.abs(n.dataInfo.minDiff)) || q < n.minimum || g > n.maximum)) z.push(n),
        p.push({
          val1: q,
          val2: g
        }),
    ...
    m.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        ...
        if (null !== C && '' !== C) {
          ...
          if ('stackedarea100' === p) {
            ...
            if (h.dataPoint.x < B.viewportMinimum || h.dataPoint.x > B.viewportMaximum || h.dataPoint.y < y.viewportMinimum || h.dataPoint.y > y.viewportMaximum) continue
          ...
          if ('normal' === this.plotInfo.axisPlacement) {
            if (0 <= p.indexOf('line') || 0 <= p.indexOf('area')) t = 'auto',
            l = 4;
             else if (0 <= p.indexOf('stacked')) 'auto' === t && (t = 'inside');
             else if ('bubble' === p || 'scatter' ===
            p) t = 'inside';
            n = h.point.x - ('horizontal' === x ? u / 2 : 0);
            'inside' !== t ? (e = c.y1, f = c.y2, 0 < J ? (q = h.point.y - z / 2 - l - b, q < e && (q = 'auto' === t ? Math.max(h.point.y, e) + z / 2 + l + b : e + z / 2 + l + b, v = q + z > h.point.y)) : (q = h.point.y + z / 2 + l + b, q > f - z - l - b && (q = 'auto' === t ? Math.min(h.point.y, f) - z / 2 - l - b : f - z / 2 - l - b, v = q < h.point.y))) : (e = Math.max(h.bounds.y1, c.y1), f = Math.min(h.bounds.y2, c.y2), b = 0 <= p.indexOf('range') || 'error' === p ? 0 < J ? Math.max(h.bounds.y1, c.y1) + z / 2 + l : Math.min(h.bounds.y2, c.y2) - z / 2 - l : (Math.max(h.bounds.y1, c.y1) + Math.min(h.bounds.y2, c.y2)) / 2, 0 < J ? (q = Math.max(h.point.y, b), q < e && ('bubble' === p || 'scatter' === p) && (q = Math.max(h.point.y - z - l, c.y1 + l))) : (q = Math.min(h.point.y, b), q > f - z - l && ('bubble' === p || 'scatter' === p) && (q = Math.min(h.point.y + l, c.y2 - z - l))), q = Math.min(q, f))
          } else 0 <= p.indexOf('line') || 0 <= p.indexOf('area') || 0 <= p.indexOf('scatter') ? (t = 'auto', e = 4) : 0 <= p.indexOf('stacked') ? 'auto' === t && (t = 'inside') : 'bubble' === p && (t = 'inside'),
          q = h.point.y,
          'inside' !== t ? (l = c.x1, f = c.x2, 0 > J ? (n = h.point.x - ('horizontal' === x ? u : u / 2) - e - b, n < l && (n = 'auto' === t ? Math.max(h.point.x, l) + e + b : l + e + b, v = n + u > h.point.x)) : (n = h.point.x + ('horizontal' === x ? 0 : u / 2) + e + b, n > f - u - e - b && (n = 'auto' === t ? Math.min(h.point.x, f) - ('horizontal' === x ? u : u / 2) - e - b : f - u - e - b, v = n < h.point.x))) : (l = Math.max(h.bounds.x1, c.x1), Math.min(h.bounds.x2, c.x2), b = 0 <= p.indexOf('range') || 'error' === p ? 0 > J ? Math.max(h.bounds.x1, c.x1) + u / 2 + e : Math.min(h.bounds.x2, c.x2) - u / 2 - e : (Math.max(h.bounds.x1, c.x1) + Math.min(h.bounds.x2, c.x2)) / 2, n = 0 > J ? Math.max(h.point.x, b) - ('horizontal' === x ? u / 2 : 0) : Math.min(h.point.x, b) - u / 2, n = Math.max(n, l));
          'vertical' ===
          x && (q += z / 2);
          g.x = n;
          g.y = q;
          g.render(!0);
          m && ('inside' !== t && (0 > p.indexOf('bar') && ('error' !== p || !h.axisSwapped) && h.point.x > c.x1 && h.point.x < c.x2 || !v) && (0 > p.indexOf('column') && ('error' !== p || h.axisSwapped) && h.point.y > c.y1 && h.point.y < c.y2 || !v)) && (d.lineWidth = m, d.strokeStyle = k ? k : 'gray', d.setLineDash && d.setLineDash(Q(A, m)), d.beginPath(), d.moveTo(h.point.x, h.point.y), 0 <= p.indexOf('bar') || 'error' === p && h.axisSwapped ? d.lineTo(n - (0 < h.direction ? 0 : - u) + ('vertical' === x ? - u / 2 : 0), q + ('vertical' === x ? - z / 2 : 0)) : 0 <= p.indexOf('column') || 'error' === p && !h.axisSwapped ? d.lineTo(n + ('horizontal' === x ? u / 2 : 0), q + ((0 < h.direction ? z : - z) + ('vertical' === x ? - z : 0)) / 2) : d.lineTo(n + ('horizontal' === x ? u / 2 : 0), q + ((q < h.point.y ? z : - z) + ('vertical' === x ? - z : 0)) / 2), d.stroke())
        }
      }
      d = {
        source: d,
      ...
      g = ma('indexLabelBackgroundColor', h.dataPoint, h.dataSeries),
      h.dataSeries.indexLabelBackgroundColor = r(g) ? s ? 'transparent' : null : g;
      return d
    };
    m.prototype.renderLine = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        c.clip();
        for (var f = [
        ], l, u = 0; u < a.dataSeriesIndexes.length; u++) {
          ...
          c.beginPath();
          if (0 < p.length) {
            for (var J = !1, t = 0; t < p.length; t++) if (x = p[t].x.getTime ? p[t].x.getTime() : p[t].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !J))) if ('number' !== typeof p[t].y) 0 < t && !(h.connectNullData || J || m) && (c.stroke(), s && b.stroke()),
            J = !0;
             else {
              ...
              m || J ? (!m && h.connectNullData ? (c.setLineDash && (h.options.nullDataLineDashType || n === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(l.x, l.y), n = h.nullDataLineDashType, c.setLineDash(q)), c.lineTo(x, r), s && b.lineTo(x, r)) : (c.beginPath(), c.moveTo(x, r), s && (b.beginPath(), b.moveTo(x, r))), J = m = !1) : (c.lineTo(x, r), s && b.lineTo(x, r), 0 == t % 500 && (c.stroke(), c.beginPath(), c.moveTo(x, r), s && (b.stroke(), b.beginPath(), b.moveTo(x, r))));
              l = {
                x: x,
                y: r
              };
              t < p.length - 1 && (k !== (p[t].lineColor || A) || n !== (p[t].lineDashType || h.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(x, r), k = p[t].lineColor || A, c.strokeStyle = k, c.setLineDash && (p[t].lineDashType ? (n = p[t].lineDashType, c.setLineDash(Q(n, h.lineThickness))) : (n = h.lineDashType, c.setLineDash(g))));
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [
          ...
          if (0 < p.length) {
            ...
            p[t].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !J))) if ('number' !== typeof p[t].y) 0 < t && !(h.connectNullData || J || m) && (c.stroke(), s && b.stroke()),
            J = !0;
             else {
              var B = r;
              x = a.axisX.convertValueToPixel(x);
              ...
              t < p.length - 1 && (k !== (p[t].lineColor || A) || n !== (p[t].lineDashType || h.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(x, r), k = p[t].lineColor || A, c.strokeStyle = k, c.setLineDash && (p[t].lineDashType ? (n = p[t].lineDashType, c.setLineDash(Q(n, h.lineThickness))) : (n = h.lineDashType, c.setLineDash(g))));
              if (0 < p[t].markerSize || 0 < h.markerSize) B = h.getMarkerProperties(t, x, r, c),
              f.push(B),
              y = S(y),
              s && f.push({
                x: x,
    ...
    m.prototype.renderSpline = function (a) {
      function d(a) {
        ...
        if (0 < a.length) {
          ...
          3; c += 3) if (b.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y), s && e.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y), 0 < c && 0 === c % 3000 || a[c + 3].newStrokeStyle || a[c + 3].newLineDashArray) b.stroke(),
          b.beginPath(),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        b.clip();
        for (var l = [
        ], u = 0; u < a.dataSeriesIndexes.length; u++) {
          var z = a.dataSeriesIndexes[u],
          h = this.data[z];
          ...
          r.length && (h.options.nullDataLineDashType || !p[m - 1].lineDashType)) && (r[r.length - 1].newLineDashArray = q, n = h.nullDataLineDashType) : (d(r), r = [
          ])),
          x = !0;
           else {
            ...
            m < p.length - 1 && (k !== (p[m].lineColor || A) || n !== (p[m].lineDashType || h.lineDashType)) && (k = p[m].lineColor || A, r[r.length - 1].newStrokeStyle = k, b.setLineDash && (p[m].lineDashType ? (n = p[m].lineDashType, r[r.length - 1].newLineDashArray = Q(n, h.lineThickness)) : (n = h.lineDashType, r[r.length - 1].newLineDashArray = g)));
        ...
        for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
          ...
          if (0 < t.length) {
            ...
            for (h = 0; h < t.length; h++) if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && 'number' === typeof t[h].y) {
              ...
              J = r + g << 0,
              B;
              if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y) u[b] = t[h].y + (u[b] ? u[b] : 0),
              0 < u[b] && (n = a.axisY.convertValueToPixel(u[b]), B = 'undefined' !== typeof f[b] ? f[b] : q, f[b] = n);
               else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) z[b] = t[h].y + (z[b] ? z[b] : 0),
        ...
        for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
          ...
          if (0 < t.length) for (var r = 5 < g && m.bevelEnabled ? !0 : !1, h = 0; h < t.length; h++) if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && 'number' === typeof t[h].y) {
            ...
            if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y) {
              ...
              B = f[b] ? f[b] : q;
              f[b] = n
            } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) z[b] = n + ('undefined' !== typeof z[b] ? z[b] : 0),
            B = a.axisY.convertValueToPixel(z[b]),
            n = l[b] ? l[b] : q,
            l[b] = B;
              ...
              f[b] = y + (B - n)
            } else y = 'undefined' !== typeof l[b] ? l[b] : 0,
            B = n + y,
            n = q + y,
            a.dataSeriesIndexes.length - 1 === A && 1 >= Math.abs(e.y2 - B) && (B = e.y2),
            l[b] = y + (B - n);
            b = t[h].color ? t[h].color : m._colorSet[h % m._colorSet.length];
            ...
            b = S(b);
            s && da(this._eventManager.ghostCtx, C, n, J, B, b, 0, null, !1, !1, !1, !1);
            (t[h].indexLabel || m.indexLabel || t[h].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
        ...
        for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
          ...
          if (0 < t.length) {
            ...
            for (h = 0; h < t.length; h++) if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && 'number' === typeof t[h].y) {
              ...
              B;
              if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y) u[b] = t[h].y + (u[b] ? u[b] : 0),
              0 < u[b] && (B = f[b] ? f[b] : q, f[b] = p = a.axisY.convertValueToPixel(u[b]));
               else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) z[b] = t[h].y + (z[b] ? z[b] : 0),
              p = l[b] ? l[b] : q,
              ...
              b = S(b);
              s && da(this._eventManager.ghostCtx, B, C, p, J, b, 0, null, !1, !1, !1, !1);
              (t[h].indexLabel || m.indexLabel || t[h].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
        ...
        for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
          ...
          if (0 < t.length) {
            ...
            for (h = 0; h < t.length; h++) if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && 'number' === typeof t[h].y) {
              ...
              } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) z[b] = C + (z[b] ? z[b] : 0),
              p = l[b] ? l[b] : q,
              ...
              C = p - y,
              p = q - y,
              a.dataSeriesIndexes.length - 1 === A && 1 >= Math.abs(e.x1 - C) && (C = e.x1),
              l[b] = y + (p - C);
              b = t[h].color ? t[h].color : m._colorSet[h % m._colorSet.length];
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          if (0 < A.length) {
            ...
            A[k].x.getTime() : A[k].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ha))) if ('number' !== typeof A[k].y) g.connectNullData || (ha || d) || b(),
            ha = !0;
             else {
              m = a.axisX.convertValueToPixel(r);
              t = a.axisY.convertValueToPixel(A[k].y);
              d || ha ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = t, m = p.x, t = p.y, b(), f.moveTo(p.x, p.y), m = d, t = c, B = p, c = g.nullDataLineDashType, f.setLineDash(K)), f.lineTo(m, t), s && l.lineTo(m, t)) : (f.beginPath(), f.moveTo(m, t), s && (l.beginPath(), l.moveTo(m, t)), B = {
                x: m,
                y: t
      ...
      function d() {
        ...
        if (0 < c.length) {
          if (0 < p.lineThickness) {
            ...
            for (var d = 0; d < c.length - 3; d += 3) if (b.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), s && e.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), c[d + 3].newStrokeStyle || c[d + 3].newLineDashArray) b.stroke(),
            b.beginPath(),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var z = 0; z < a.dataSeriesIndexes.length; z++) {
          ...
          if (0 < n.length) {
            ...
            for (A = !1; q < n.length; q++) if (g = n[q].x.getTime ? n[q].x.getTime() : n[q].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!p.connectNullData || !A))) if ('number' !== typeof n[q].y) 0 < q && !A && (p.connectNullData ? b.setLineDash && (0 < r.length && (p.options.nullDataLineDashType || !n[q - 1].lineDashType)) && (r[r.length - 1].newLineDashArray = w, y = p.nullDataLineDashType) : (d(), r = [
            ])),
            A = !0;
             else {
              ...
              q < n.length - 1 && (B !== (n[q].lineColor || J) || y !== (n[q].lineDashType || p.lineDashType)) && (B = n[q].lineColor || J, r[r.length - 1].newStrokeStyle = B, b.setLineDash && (n[q].lineDashType ? (y = n[q].lineDashType, r[r.length - 1].newLineDashArray = Q(y, p.lineThickness)) : (y = p.lineDashType, r[r.length - 1].newLineDashArray = D)));
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          if (0 < A.length) {
            ...
            for (; k < A.length; k++) if (r = A[k].x.getTime ? A[k].x.getTime() : A[k].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
              var $ = t;
              'number' !== typeof A[k].y ? (g.connectNullData || (c || d) || b(), c = !0) : (m = a.axisX.convertValueToPixel(r), t = a.axisY.convertValueToPixel(A[k].y), d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || K === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = t, m = p.x, t = p.y, b(), f.moveTo(p.x, p.y), m = d, t = c, B = p, K = g.nullDataLineDashType, f.setLineDash(P)), f.lineTo(m, $), f.lineTo(m, t), s && (l.lineTo(m, $), l.lineTo(m, t))) : (f.beginPath(), f.moveTo(m, t), s && (l.beginPath(), l.moveTo(m, t)), B = {
                x: m,
                y: t
              }), c = d = !1) : (f.lineTo(m, $), s && l.lineTo(m, $), f.lineTo(m, t), s && l.lineTo(m, t), 0 == k % 250 && b()), p = {
                x: m,
                y: t
              }, k < A.length - 1 && (w !== (A[k].lineColor || v) || K !== (A[k].lineDashType || g.lineDashType)) && (b(), w = A[k].lineColor || v, f.strokeStyle = w, f.setLineDash && (A[k].lineDashType ? (K = A[k].lineDashType, f.setLineDash(Q(K, g.lineThickness))) : (K = g.lineDashType, f.setLineDash(D)))), r = g.dataPointIds[k], this._eventManager.objectMap[r] = {
                id: r,
                objectType: 'dataPoint',
                dataSeriesIndex: q,
                dataPointIndex: k,
    ...
    m.prototype.renderStackedArea = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var e = [
        ], J = 0; J < a.dataSeriesIndexes.length; J++) {
          var B = a.dataSeriesIndexes[J],
          y = this.data[B],
          v = y.dataPoints;
          y.dataPointIndexes = [
          ];
          for (q = 0; q < v.length; q++) B = v[q].x.getTime ? v[q].x.getTime() : v[q].x,
        ...
        for (J = 0; J < a.dataSeriesIndexes.length; J++) {
          ...
          if (0 < p.length) {
            ...
            for (var $ = !0, q = 0; q < p.length; q++) {
              ...
              if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!y.connectNullData || !$))) if ('number' !== typeof ia.y) y.connectNullData || ($ || x) || d(),
              $ = !0;
               else {
                ...
                } else k = a.axisY.convertValueToPixel(ia.y),
                k -= na;
                h.push({
                  x: g,
                  y: m - na
                ...
                z[f] = m - k;
                x || $ ? (!x && y.connectNullData ? (b.setLineDash && (y.options.nullDataLineDashType || C === y.lineDashType && y.lineDashType !== y.nullDataLineDashType) && (x = h.pop(), C = h[h.length - 1], d(), b.moveTo(t.x, t.y), h.push(C), h.push(x), C = y.nullDataLineDashType, b.setLineDash(P)), b.lineTo(g, k), s && r.lineTo(g, k)) : (b.beginPath(), b.moveTo(g, k), s && (r.beginPath(), r.moveTo(g, k))), $ = x = !1) : (b.lineTo(g, k), s && r.lineTo(g, k), 0 == q % 250 && (d(), b.moveTo(g, k), s && r.moveTo(g, k), h.push({
                  x: g,
                  y: m - na
                })));
                t = {
                ...
                q < v.length - 1 && (K !== (v[q].lineColor || w) || C !== (v[q].lineDashType || y.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, k), h.push({
                  x: g,
                  y: m - na
                }), K = v[q].lineColor || w, b.strokeStyle = K, b.setLineDash && (v[q].lineDashType ? (C = v[q].lineDashType, b.setLineDash(Q(C, y.lineThickness))) : (C = y.lineDashType, b.setLineDash(D))));
    ...
    m.prototype.renderStackedArea100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var e = [
        ], v = 0; v < a.dataSeriesIndexes.length; v++) {
          var B = a.dataSeriesIndexes[v],
          y = this.data[B],
          w = y.dataPoints;
          y.dataPointIndexes = [
          ];
          for (q = 0; q < w.length; q++) B = w[q].x.getTime ? w[q].x.getTime() : w[q].x,
          y.dataPointIndexes[B] = q,
          e[B] || (p.push(B), e[B] = !0);
          p.sort(Pa)
        }
        for (v = 0; v < a.dataSeriesIndexes.length; v++) {
          ...
          if (0 < p.length) {
            ...
            for (var $ = !0, q = 0; q < p.length; q++) {
              ...
              if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!y.connectNullData || !$))) if ('number' !== typeof ia.y) y.connectNullData || ($ || O) || d(),
              $ = !0;
               else {
                var na;
                ...
                } else m = a.axisY.convertValueToPixel(na),
                m -= ca;
                h.push({
                  x: g,
                  y: x - ca
                ...
                k[f] = x - m;
                O || $ ? (!O && y.connectNullData ? (b.setLineDash && (y.options.nullDataLineDashType || t === y.lineDashType && y.lineDashType !== y.nullDataLineDashType) && (O = h.pop(), t = h[h.length - 1], d(), b.moveTo(r.x, r.y), h.push(t), h.push(O), t = y.nullDataLineDashType, b.setLineDash(P)), b.lineTo(g, m), s && C.lineTo(g, m)) : (b.beginPath(), b.moveTo(g, m), s && (C.beginPath(), C.moveTo(g, m))), $ = O = !1) : (b.lineTo(g, m), s && C.lineTo(g, m), 0 == q % 250 && (d(), b.moveTo(g, m), s && C.moveTo(g, m), h.push({
                  x: g,
                  y: x - ca
                })));
                r = {
    ...
    m.prototype.renderBubble = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var u = - Infinity, k = Infinity, h = 0; h < a.dataSeriesIndexes.length; h++) for (var p = a.dataSeriesIndexes[h], n = this.data[p], q = n.dataPoints, g = 0, e = 0; e < q.length; e++) f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x,
        f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || 'undefined' === typeof q[e].z || (g = q[e].z, g > u && (u = g), g < k && (k = g));
    ...
    m.prototype.renderCandlestick = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var ga = 0; ga < a.dataSeriesIndexes.length; ga++) {
          ...
          t = this.data[O],
          x = t.dataPoints;
          if (0 < x.length) for (var C = 5 < m && t.bevelEnabled ? !0 : !1, u = 0; u < x.length; u++) if (x[u].getTime ? g = x[u].x.getTime() : g = x[u].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(x[u].y) && x[u].y.length && 'number' === typeof x[u].y[0] && 'number' === typeof x[u].y[1] && 'number' === typeof x[u].y[2] && 'number' === typeof x[u].y[3]) {
            ...
            'candlestick' === t.type ? (c.moveTo(k - w, p), c.lineTo(k - w, Math.min(h, q)), c.stroke(), c.moveTo(k - w, Math.max(h, q)), c.lineTo(k - w, n), c.stroke(), da(c, v, Math.min(h, q), B, Math.max(h, q), x[u].y[0] <= x[u].y[3] ? t.risingColor : f, y, e, C, C, !1, !1, t.fillOpacity), s && (e = S(D), b.strokeStyle = e, b.moveTo(k - w, p), b.lineTo(k - w, Math.min(h, q)), b.stroke(), b.moveTo(k - w, Math.max(h, q)), b.lineTo(k - w, n), b.stroke(), da(b, v, Math.min(h, q), B, Math.max(h, q), e, 0, null, !1, !1, !1, !1))) : 'ohlc' === t.type && (c.moveTo(k - w, p), c.lineTo(k - w, n), c.stroke(), c.beginPath(), c.moveTo(k, h), c.lineTo(v, h), c.stroke(), c.beginPath(), c.moveTo(k, q), c.lineTo(B, q), c.stroke(), s && (e = S(D), b.strokeStyle = e, b.moveTo(k - w, p), b.lineTo(k - w, n), b.stroke(), b.beginPath(), b.moveTo(k, h), b.lineTo(v, h), b.stroke(), b.beginPath(), b.moveTo(k, q), b.lineTo(B, q), b.stroke()));
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var ga = !1, ga = !!a.axisY.reversed, O = 0; O < a.dataSeriesIndexes.length; O++) {
          ...
          if (0 < C.length) for (var v = 5 < m && x.bevelEnabled ? !0 : !1, l = 0; l < C.length; l++) if (C[l].getTime ? g = C[l].x.getTime() : g = C[l].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(C[l].y) && C[l].y.length && 'number' === typeof C[l].y[0] && 'number' === typeof C[l].y[1] && 'number' === typeof C[l].y[2] && 'number' === typeof C[l].y[3] && 'number' === typeof C[l].y[4] && 5 === C[l].y.length) {
            ...
            (C[l].indexLabel || x.indexLabel || C[l].indexLabelFormatter || x.indexLabelFormatter) && this._indexLabels.push({
              chartType: x.type,
              dataPoint: C[l],
              dataSeries: x,
              point: {
    ...
    m.prototype.renderRangeColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
          ...
          q = this.data[n],
          g = q.dataPoints;
          if (0 < g.length) for (var m = 5 < h && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++) if (g[f].getTime ? k = g[f].x.getTime() : k = g[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !r(g[f].y) && g[f].y.length && 'number' === typeof g[f].y[0] && 'number' === typeof g[f].y[1]) {
    ...
    m.prototype.renderError = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
          ...
          D = 0;
          if (y) for (e = v._linkedSeries.id, t = 0; t < e; t++) !this.data[t].type.match(/(bar|column)/gi) || !this.data[t].visible || this.data[t].type.match(/(stacked)/gi) && D || (this.data[t].type.match(/(range)/gi) && (f = !0), D++);
          e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
    ...
    m.prototype.renderRangeArea = function (a) {
      function d() {
        if (x) {
          for (var a = null, c = k.length - 1; 0 <= c; c--) a = k[c],
          b.lineTo(a.x, a.y2),
          e.lineTo(a.x, a.y2);
          b.closePath();
          b.globalAlpha = p.fillOpacity;
        ...
        for (var u = 0; u < a.dataSeriesIndexes.length; u++) {
          ...
          if (0 < n.length) {
            ...
            for (var K = !0; g < n.length; g++) if (t = n[g].x.getTime ? n[g].x.getTime() : n[g].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!p.connectNullData || !K))) if (null !== n[g].y && n[g].y.length && 'number' === typeof n[g].y[0] && 'number' === typeof n[g].y[1]) {
              ...
              q || K ? (p.connectNullData && !q ? (b.setLineDash && (p.options.nullDataLineDashType || y === p.lineDashType && p.lineDashType !== p.nullDataLineDashType) && (k[k.length - 1].newLineDashArray = E, y = p.nullDataLineDashType, b.setLineDash(D)), b.lineTo(m, r), s && e.lineTo(m, r), k.push({
                x: m,
                y1: r,
                y2: v
    ...
    m.prototype.renderRangeSplineArea = function (a) {
      function d(a, c) {
        ...
        if (0 < d.length) {
          ...
          s && e.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y);
          d = v(O, 2);
          b.lineTo(O[O.length -
          1].x, O[O.length - 1].y);
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var k = 0; k < a.dataSeriesIndexes.length; k++) {
          ...
          if (0 < p.length) {
            ...
            for (g = !1; n < p.length; n++) if (q = p[n].x.getTime ? p[n].x.getTime() : p[n].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !g))) if (null !== p[n].y && p[n].y.length && 'number' === typeof p[n].y[0] && 'number' === typeof p[n].y[1]) {
              ...
              g = !1
            } else 0 < n && !g && (h.connectNullData ? b.setLineDash && (0 < r.length && (h.options.nullDataLineDashType || !p[n - 1].lineDashType)) && (r[r.length - 1].newLineDashArray = y, w = h.nullDataLineDashType) : (d(B, x), r = [
            ], O = [
            ])),
            g = !0;
            d(B, x);
    ...
    var Z = function (a, d, c, b, e, f, l, k, m) {
      if (!(0 > c)) {
        ...
        if (!s) {
          ...
          Number((f % (2 * Math.PI)).toFixed(8)) === h && (l -= 0.0001)
        }
        a.save();
        a.globalAlpha = k;
    ...
    m.prototype.renderPie = function (a) {
      function d() {
        if (h && p) {
          ...
          l = f = 0;
          k = !1;
          for (e = 0; e < p.length; e++) n = g[(c + e) % p.length],
          1 < a && (n.midAngle > Math.PI / 2 - t && n.midAngle < Math.PI / 2 + t) && (f <= a / 2 && !k ? (n.hemisphere = 'right', f++) : (n.hemisphere = 'left', k = !0));
          k = !1;
          for (e = 0; e < p.length; e++) n = g[(d + e) % p.length],
          1 < b && (n.midAngle > 3 * Math.PI / 2 - t && n.midAngle < 3 * Math.PI / 2 + t) && (l <= b / 2 && !k ? (n.hemisphere = 'left', l++) : (n.hemisphere = 'right', k = !0))
        }
      }
      function c(a) {
        ...
        p.length; b++) {
          ...
          if (d > c) {
            ...
            l = !1;
            if (p[b].exploded) {
              if (1e-9 < Math.abs(g[b].center.x - (C.x + e)) || 1e-9 < Math.abs(g[b].center.y - (C.y + f))) g[b].center.x = C.x + e * a,
              g[b].center.y = C.y + f * a,
              l = !0
            } else if (0 < Math.abs(g[b].center.x - C.x) || 0 < Math.abs(g[b].center.y - C.y)) g[b].center.x = C.x + e * (1 - a),
            g[b].center.y = C.y + f * (1 - a),
            l = !0;
            l && (e = {
            }, e.dataSeries = h, e.dataPoint = h.dataPoints[b], e.index = b, m.toolTip.highlightObjects([e]));
        ...
        a.lineJoin = 'round';
        for (b = b = 0; b < p.length; b++) c = g[b],
        c.indexLabelText && (c.indexLabelTextBlock.y -= c.indexLabelTextBlock.height / 2, d = 0, d = 'left' === c.hemisphere ? 'inside' !== h.indexLabelPlacement ? - (c.indexLabelTextBlock.width + n) : - c.indexLabelTextBlock.width / 2 : 'inside' !==
        h.indexLabelPlacement ? n : - c.indexLabelTextBlock.width / 2, c.indexLabelTextBlock.x += d, c.indexLabelTextBlock.render(!0), c.indexLabelTextBlock.x -= d, c.indexLabelTextBlock.y += c.indexLabelTextBlock.height / 2, 'inside' !== c.indexLabelPlacement && 0 < c.indexLabelLineThickness && (d = c.center.x + y * Math.cos(c.midAngle), e = c.center.y + y * Math.sin(c.midAngle), a.strokeStyle = c.indexLabelLineColor, a.lineWidth = c.indexLabelLineThickness, a.setLineDash && a.setLineDash(Q(c.indexLabelLineDashType, c.indexLabelLineThickness)), a.beginPath(), a.moveTo(d, e), a.lineTo(c.indexLabelTextBlock.x, c.indexLabelTextBlock.y), a.lineTo(c.indexLabelTextBlock.x + ('left' === c.hemisphere ? - n : n), c.indexLabelTextBlock.y), a.stroke()), a.lineJoin = 'miter');
        a.save()
      }
      function b(a, b) {
        var c = 0,
      ...
      function f(a, c, d) {
        ...
        if (0 <= a && a < p.length) {
          ...
          l = 0;
          l = 'right' === m.hemisphere ? C.x + Math.sqrt(Math.pow(s, 2) - Math.pow(c - C.y, 2)) : C.x - Math.sqrt(Math.pow(s, 2) - Math.pow(c - C.y, 2));
      ...
      function l() {
        ...
        for (var c = a = 0, d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
            ...
            for (var u, t, a = 0; a < p.length; a++) {
              ...
              if (null !== r) {
                ...
                if (0 > B) {
                  ...
                  var w = - 1 * (B - t),
                  I = J = 0;
                  'right' === k.hemisphere ? (J = f(a, t), w = - 1 * (B - J), I = f(r, w), + I.toFixed(x) < + w.toFixed(x) && + J.toFixed(x) <= + t.toFixed(x) && f(a, - (w - I))) : (J = f(r, t), w = - 1 * (B - J), I = f(a, w), + I.toFixed(x) < + w.toFixed(x) && + J.toFixed(x) <= + t.toFixed(x) && f(r, - (w - I)))
                }
              }
            }
          } else for (a = 0; a < p.length; a++) k = g[a],
          ...
          for (a = 0; a < p.length; a++) if (k = g[a], r = k.indexLabelTextBlock.measureText(), 0 !== r.height && 0 !== r.width) r = r = 0,
          ...
          0 < r && (!l && k.indexLabelText && (t = 'right' === k.hemisphere ? q.x2 - k.indexLabelTextBlock.x : k.indexLabelTextBlock.x - q.x1, 0.3 * k.indexLabelTextBlock.maxWidth > t ? k.indexLabelText = '' : k.indexLabelTextBlock.maxWidth = 0.85 * t, 0.3 * k.indexLabelTextBlock.maxWidth < t && (k.indexLabelTextBlock.x -= 'right' === k.hemisphere ? 2 : - 2)), Math.abs(k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 - C.y) < y || Math.abs(k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2 - C.y) < y) && (r /= Math.abs(Math.cos(k.indexLabelAngle)), 9 < r && (r *= 0.3), r > d && (d = r)),
          r = r = 0,
          0 < k.indexLabelAngle && k.indexLabelAngle < Math.PI ? (r = q.y2 - (k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2 + 5), r *= - 1) : r = q.y1 - (k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 - 5),
          0 < r && (!l && k.indexLabelText && (t = 0 < k.indexLabelAngle && k.indexLabelAngle < Math.PI ? - 1 : 1, 0 === f(a, r * t) && f(a, 2 * t)), Math.abs(k.indexLabelTextBlock.x - C.x) < y && (r /= Math.abs(Math.sin(k.indexLabelAngle)), 9 < r && (r *= 0.3), r > d && (d = r)));
          var G = function (a, b, c) {
            for (var d = [
            ], e = 0; d.push(g[b]), b !== c; b = (b + 1 + p.length) % p.length);
            d.sort(function (a, b) {
              return a.y - b.y
            });
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        w = 0;
        a = !1;
        for (var B = 0; B < p.length; B++) w += Math.abs(p[B].y),
    ...
    m.prototype.renderFunnel = function (a) {
      ...
      function c() {
        ...
        if (0 === g) return - 1;
        for (var l = d[0] = 0, k = 0, n, m, b = b - a, l = !1, h = 0; h < x.length; h++) a = Math.abs(x[h].y) * f / g,
        l ? n = 0 == Number(c.toFixed(3)) ? 0 : a / c : (m = ba * ba * b * b - 4 * Math.abs(ba) * a, 0 > m ? (m = c, l = (b + m) * (e - k) / 2, a -= l, n = e - k, k += e - k, n += 0 == m ? 0 : a / m, k += a / m, l = !0) : (n = (Math.abs(ba) * b - Math.sqrt(m)) / 2, m = b - 2 * n / Math.abs(ba), k += n, k > e && (k -= n, m = c, l = (b + m) * (e - k) / 2, a -= l, n = e - k, k += e - k, n += a / m, k += a / m, l = !0), b = m)),
        d.push(n);
        return d
      }
      function b() {
        if (t && x) {
          for (var a, b, c, d, e, f, h, l, k, n, m, p, q, u, A = [
          ], z = [
          ], v = {
            percent: null,
            total: null
          }, C = null, y = 0; y < x.length; y++) u = R[y],
          u = 'undefined' !== typeof u.x5 ? (u.y2 + u.y4) / 2 : (u.y2 + u.y3) / 2,
          u = g(u).x2 + 1,
          A[y] = N - u - W;
          u = 0.5 * W;
      ...
      function e() {
        ...
        if (e) for (l = H.length - 1; 0 <= l; l--) a = R[l],
        H[l].textBlock.maxWidth = f[f.length - (l + 1)],
        H[l].textBlock.measureText(),
        H[l].textBlock.x = N - h,
        c = H[l].textBlock.height <
        H[l].textBlock.maxHeight ? H[l].textBlock.height : H[l].textBlock.maxHeight,
        ...
        t.reversed ? (H[l].textBlock.y + H[l].height > U + D && (H[l].textBlock.y = U + D - H[l].height), H[l].textBlock.y < sa - D && (H[l].textBlock.y = sa - D)) : (H[l].textBlock.y < U - D && (H[l].textBlock.y = U - D), H[l].textBlock.y + H[l].height > sa + D && (H[l].textBlock.y = sa + D - H[l].height))
      }
      function f() {
        var a,
        b,
        c,
        d;
        if ('inside' !== t.indexLabelPlacement) for (var e = 0; e < R.length; e++) 0 == H[e].textBlock.text.length ? H[e].isDirty = !0 : (a = R[e], c = 'undefined' !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, b = t.reversed ? 'undefined' !== typeof a.x5 ? c > xa ? g(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1 : 'undefined' !== typeof a.x5 ? c < xa ? g(c).x2 + 1 : (a.x4 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1, H[e].textBlock.x = b + W, H[e].textBlock.y = c - H[e].height / 2, t.reversed ? (H[e].textBlock.y + H[e].height > U + D && (H[e].textBlock.y = U + D - H[e].height), H[e].textBlock.y < sa - D && (H[e].textBlock.y = sa - D)) : (H[e].textBlock.y < U - D && (H[e].textBlock.y = U - D), H[e].textBlock.y + H[e].height > sa + D && (H[e].textBlock.y = sa + D - H[e].height)));
         else for (e = 0; e < R.length; e++) 0 == H[e].textBlock.text.length ? H[e].isDirty = !0 : (a = R[e], b = a.height, c = H[e].height, d = H[e].width, b >= c ? (b = e != da ? (a.x4 + a.x3) / 2 - d / 2 : (a.x5 + a.x4) / 2 - d / 2, c = e != da ? (a.y1 + a.y3) / 2 - c / 2 : (a.y1 + a.y4) / 2 - c / 2, H[e].textBlock.x = b, H[e].textBlock.y = c) : H[e].isDirty = !0)
      }
      function l() {
        function a(b, c) {
          var d;
          ...
          if (d >= c) return f.y += c,
          c;
          if (b == R.length - 1) return 0 < d && (f.y += d),
          d;
          d += a(e, c - d);
          0 < d && (f.y += d);
          return d
      ...
      function m(a, b, c) {
        ...
        var u = {
          ...
          changeSection: function (a) {
            for (var b, c, d = 0; d < R.length; d++) b = g[d],
            c = R[d],
            b *= a,
      ...
      function p(a) {
        for (var b, c, d, e, f = 0; f < R.length; f++) e = 1 === H[f].lineThickness % 2 ? 0.5 : 0,
        c = ((R[f].y2 + R[f].y4) / 2 << 0) + e,
        b = g(c).x2 - 1,
        d = H[f].textBlock.x,
        e = (H[f].textBlock.y + H[f].height / 2 << 0) + e,
        H[f].isDirty || 0 == H[f].lineThickness || (a.strokeStyle = H[f].lineColor, a.lineWidth = H[f].lineThickness, a.setLineDash && a.setLineDash(Q(H[f].lineDashType, H[f].lineThickness)), a.beginPath(), a.moveTo(b, c), a.lineTo(d, e), a.stroke())
      }
      function n(a) {
      ...
      function v(a) {
        ...
        if (w.subtitles) for (var b = 0; b < w.subtitles.length; b++) {
          var c = w.subtitles[b];
          if (c.dockInsidePlotArea || 'center' === c.horizontalAlign && 'center' === c.verticalAlign) w.subtitles.ctx = a,
          c.render()
        }
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        if (0 != t.length && (t.dataPoints && t.visible) && 0 !== x.length) {
          ...
          if ( - 1 !== P) {
            if (t.reversed) for (G.push(V), F = P.length - 1; 0 < F; F--) V += P[F],
            G.push(V);
             else for (F = 0; F < P.length; F++) V += P[F],
            G.push(V);
            if (t.reversed) for (F = 0; F < P.length; F++) G[F] < xa ? (a.push(M), B.push(Y), da = F) : (a.push((G[F] - U + ba * X) / ba), B.push((G[F] - U + fa * aa) / fa));
             else for (F = 0; F < P.length; F++) G[F] < xa ? (a.push((G[F] - U + ba * X) / ba), B.push((G[F] - U + fa * aa) / fa), da = F) : (a.push(M), B.push(Y));
            for (F = 0; F < P.length - 1; F++) V = t.reversed ? x[x.length - 1 - F].color ? x[x.length - 1 - F].color : t._colorSet[(x.length -
            1 - F) % t._colorSet.length] : x[F].color ? x[F].color : t._colorSet[F % t._colorSet.length],
            F === da ? R.push({
              x1: a[F],
              y1: G[F],
              x2: B[F],
            ...
            for (F = 0; F < R.length; F++) y = R[F],
            qa(S, y, t.fillOpacity),
            ja.push(y.y1);
            v(S);
            K && t.visible && ('inside' === t.indexLabelPlacement || w.animationEnabled || p(S), w.animationEnabled || A());
            if (!K) for (F = 0; F < x.length; F++) y = t.dataPointIds[F],
            a = {
              id: y,
              objectType: 'dataPoint',
              dataPointIndex: F,
    ...
    m.prototype.getPercentAndTotal = function (a, d) {
      ...
      c in a.plotUnit.yTotals && (b = a.plotUnit.yTotals[c], e = isNaN(d.y) ? 0 : 100 * (d.y / b));
    ...
    E.prototype.setLayout = function () {
      ...
      if (0 < m.length) {
        ...
        for (p = 0; p < m.length; p++) {
          ...
          if (!(0 >= l || 'undefined' === typeof l || 0 >= v || 'undefined' === typeof v)) {
            ...
            q.textBlock.measureText(),
            null !== this.itemWidth && (q.textBlock.width = this.itemWidth - (s + k + ('line' === q.chartType || 'spline' === q.chartType || 'stepLine' === q.chartType ? 2 * 0.1 * this.lineHeight : 0))),
            this.height < l - this.lineHeight ? (n = {
              items: [
              ],
              width: 0
            }, h.push(n)) : (n = h[x], x = (x + 1) % h.length),
      ...
      this.items = m;
      for (p = 0; p < this.items.length; p++) q = m[p],
    ...
    G.prototype.getDataPointAtXY = function (a, d, c) {
      ...
      n = 0 < q ? Math.min(Math.max((this.dataPoints.length - 1) / q * (n - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0;
      for (; ; ) {
        f = 0 < l ? n + e : n - e;
        if (0 <= f && f < this.dataPoints.length) {
    ...
    D.prototype.createLabels = function () {
      ...
      q = n = 0;
      if (this.labelAutoFit || this.options.labelAutoFit) if (r(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), 'bottom' === this._position || 'top' === this._position) if (f = 0.9 * k >> 0, q = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
        ...
        for (c = 0; c < this._labels.length; c++) if (!this._labels[c].breaksLabelType) {
          ...
          for (var v, g = a.text.split(' '), b = 0; b < g.length; b++) p = g[b],
        ...
        for (c = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; c < this._labels.length; c++) if (!this._labels[c].breaksLabelType) {
          ...
          if (r(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle) if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? l : Math.min((b - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b), p = (h - (m + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs( - 25))) / Math.sin(Math.PI / 180 * Math.abs( - 25)), !r(this.options.labelWrap)) this.labelWrap ? r(this.options.labelMaxWidth) ? (this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, q), p), this.sessionVariables.labelWrap = this.labelWrap, d && A.width + d.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = - 25)) : (this.sessionVariables.labelWrap = this.labelWrap, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > f ? - 25 : this.sessionVariables.labelAngle) : r(this.options.labelMaxWidth) ? (this.sessionVariables.labelWrap = this.labelWrap, this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelMaxWidth = f, d && A.width + d.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = - 25, this.sessionVariables.labelMaxWidth = p)) : (this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > f ? - 25 : this.sessionVariables.labelAngle, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelWrap = this.labelWrap);
            ...
            f ? (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = b) : (this.sessionVariables.labelAngle = - 25, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = l);
             else if (!r(d)) if (b = A.width + d.width >> 0, g = this.labelFontSize, q < f) b - 2 * f > n && (n = b - 2 * f, b >= 2 * f && b < 2.2 * f ? (this.sessionVariables.labelMaxWidth = f, r(this.options.labelFontSize) && 12 < g && (g = Math.floor(12 / 13 * g), a.measureText()), this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ?
            ...
            this.sessionVariables.labelMaxWidth = p;
             else if (0 === n) for (this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, b = 0; b < this._labels.length; b++) a = this._labels[b].textBlock,
            a.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, q), p),
            A = a.measureText(),
            b < this._labels.length - 1 && (g = b + 1, d = this._labels[g].textBlock, d.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, q), p), d = d.measureText(), A.width + d.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = - 25))
      ...
      a.measureText();
        ...
        for (c = 0; c < this._labels.length; c++) if (!this._labels[c].breaksLabelType) {
          ...
          this.labelFontSize : this.options.labelFontSize, this.sessionVariables.labelMaxWidth = f, this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelAngle = r(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle) : k > 10 * l && k < 50 * l && (r(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize), a.measureText()), this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize, this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelMaxWidth = f, this.sessionVariables.labelAngle = r(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle))) : (this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth)) : (this.sessionVariables.labelMaxWidth = this.labelWrap ? this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth : this.labelMaxWidth ? this.options.labelMaxWidth ?
    ...
    D.setLayout = function (a, d, c, b, e, f) {
      ...
      for (g = 0; g < q.length; g++) if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length) for (var A = q[g].scaleBreaks._appliedBreaks, s = 0; s < A.length && !(A[s].startValue > q[g].viewportMaximum); s++) A[s].endValue < q[g].viewportMinimum || (r(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex = s), A[s].startValue >= q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = s));
      ...
      if ('normal' === e) {
        ...
        s; ) {
          ...
          ], g = R = 0; g < c.length; g++) D.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)),
          R += D[g],
          M += c[g] && !p.isNavigator ? c[g].margin : 0;
           else D.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
          S.push(D);
          if (b && 0 < b.length) for (B = [
          ], g = ba = 0; g < b.length; g++) B.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateWidth() : 0)),
          ba += B[g],
          aa += b[g] ? b[g].margin : 0;
          ...
          if (a && 0 < a.length) for (x = [
          ], g = V = 0; g < a.length; g++) a[g] && (a[g].lineCoordinates = {
          }),
          ...
          N.push(x);
          if (d && 0 < d.length) for (w = [
          ], g = Y = 0; g < d.length; g++) d[g] && (d[g].lineCoordinates = {
          }),
          ...
          0));
          Q.push(w);
          if (a && 0 < a.length) for (g = 0; g < a.length; g++) a[g] && (a[g].lineCoordinates.x1 = l, m = Math.round(f.x2 - ba - aa > p.width - n ? p.width - n : f.x2 - ba - aa), a[g]._labels && 1 < a[g]._labels.length && (k = h = 0, h = a[g]._labels[1], k = 'dateTime' === a[g].valueType ? a[g]._labels[a[g]._labels.length - 2] : a[g]._labels[a[g]._labels.length - 1], v = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - k.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)), t = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - k.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle))), !a[g] || (!a[g].labelAutoFit || r(y) || r(E) || p.isNavigator || p.stockChart) || (k = 0, 0 < a[g].labelAngle ? E + t > m && (k += 0 < a[g].labelAngle ? E + t - m - ba : 0) : 0 > a[g].labelAngle ? y - v < l && y - v < a[g].viewportMinimum && (G = l - (M + a[g].tickLength + D + y - v + a[g].labelFontSize / 2)) : 0 === a[g].labelAngle && (E + t > m && (k = E + t / 2 - m - ba), y - v < l && y - v < a[g].viewportMinimum && (G = l - M - a[g].tickLength - D - y + v / 2)), a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 < a[g].labelAngle && 0 < k ? m -= k : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 > a[g].labelAngle && 0 < G ? l += G : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 === a[g].labelAngle && (0 < G && (l += G), 0 < k && (m -= k))), p.panEnabled ? V = r(p.sessionVariables.axisX.height) ? p.sessionVariables.axisX.height = V : p.sessionVariables.axisX.height : p.sessionVariables.axisX.height = V, k = Math.round(f.y2 - V - e + F), h = Math.round(f.y2), a[g].lineCoordinates.x2 = m, a[g].lineCoordinates.width = m - l, a[g].lineCoordinates.y1 = k, a[g].lineCoordinates.y2 = k + a[g].lineThickness / 2, 'inside' === a[g].labelPlacement && 0 < g && (a[g].lineCoordinates.y1 = a[g].lineCoordinates.y1 + x[g] - (a[g]._titleTextBlock ? a[g]._titleTextBlock.height : 0) - ('inside' === a[g].tickPlacement ? a[g].tickLength : 0), a[g].lineCoordinates.y2 = a[g].lineCoordinates.y1 + a[g].lineThickness / 2), a[g].bounds = {
            x1: l,
            y1: k,
            x2: m,
            y2: h - (V + e - x[g] - F),
          ...
          'inside' === d[g].labelPlacement && 0 < g && (d[g].lineCoordinates.y1 = d[g - 1].bounds.y1 - w[g] + (d[g]._titleTextBlock ? d[g]._titleTextBlock.height :
          0)),
          d[g].bounds = {
            x1: l,
            y1: k + (Y + Z - w[g] - W),
          ...
          W += w[g] + d[g].margin;
          if (c && 0 < c.length) for (g = 0; g < c.length; g++) M = p.isNavigator ? 0 : 10,
          c[g] && (l = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), M = c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[c[g]._labels.length - 1].textBlock.height / 2 : n, k = Math.round(f.y1 + Y + Z < Math.max(M, n) ? Math.max(M, n) : f.y1 + Y + Z), m = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), M = 0 < a.length ? 0 : c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[0].textBlock.height / 2 : n, h = Math.round(f.y2 - V - e - M), c[g].lineCoordinates = {
            x1: l - U,
            y1: k,
            x2: m - U,
            y2: h,
          ...
          d[g]._labels && 1 < d[g]._labels.length && (y = (d[g].logarithmic ?
          Math.log(d[g]._labels[1].position / d[g].viewportMinimum) / d[g].conversionParameters.lnLogarithmBase : d[g]._labels[1].position - d[g].viewportMinimum) * Math.abs(d[g].conversionParameters.pixelPerUnit) + d[g].lineCoordinates.x1, l = d[g]._labels[d[g]._labels.length - ('dateTime' === d[g].valueType ? 2 : 1)].position, l = d[g].getApparentDifference(d[g].viewportMinimum, l), E = d[g].logarithmic ? (1 < l ? Math.log(l) / d[g].conversionParameters.lnLogarithmBase * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1 : (0 < l ? l * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1);
          for (g = 0; g < q.length; g++) 'axisY' === q[g].type && (q[g].calculateValueToPixelConversionParameters(), q[g].calculateBreaksSizeInValues());
          if (0 < s) {
            if (a && 0 < a.length) for (g = 0; g < a.length; g++) A = N[s - 1][g] === N[s][g] ? !0 : !1;
             else A = !0;
        ...
        for (Q = [
          ...
          ], g = X = 0; g < a.length; g++) G.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateWidth() : 0)),
          X += G[g],
          e += a[g] && !p.isNavigator ? a[g].margin : 0;
           else G.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
          N.push(G);
          if (d && 0 < d.length) for (v = [
          ], g = V = 0; g < d.length; g++) v.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateWidth() : 0)),
          V += v[g],
          Z += d[g] ? d[g].margin : 0;
          ...
          c[g].labelAutoFit && !r(x) && (0 < !a.length && (l = 0 > c[g].labelAngle ? Math.max(l, x) : 0 === c[g].labelAngle ? Math.max(l, x / 2) : l), 0 < !d.length && (m = 0 < c[g].labelAngle ? m - w / 2 : 0 === c[g].labelAngle ? m - w / 2 : m)),
          ...
          b[g] && b[g].labelAutoFit && !r(D) && (0 < !a.length && (l = 0 < b[g].labelAngle ? Math.max(l, D) : 0 === b[g].labelAngle ? Math.max(l, D / 2) : l), 0 < !d.length && (m -= B / 2)),
          ...
          if (c && 0 < c.length) for (n = [
          ], g = U = 0; g < c.length; g++) n.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateHeight() : 0)),
          U += n[g] + c[g].margin,
          M += c[g].margin;
           else n.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
          E.push(n);
          if (b && 0 < b.length) for (y = [
          ], g = W = 0; g < b.length; g++) y.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)),
          W += y[g],
          aa += b[g].margin;
          ...
          if (c && 0 < c.length) for (g = c.length - 1; 0 <= g; g--) k = Math.round(f.y2),
          ...
          'inside' === c[g].labelPlacement && 0 < g && (c[g].lineCoordinates.y1 = c[g].lineCoordinates.y1 + n[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0) - ('inside' ===
          ...
          Y += n[g] + c[g].margin;
          if (b && 0 < b.length) for (g = b.length - 1; 0 <= g; g--) b[g] && (k = Math.round(f.y1), h = Math.round(f.y1 + (y[g] + b[g].margin + F)), b[g].lineCoordinates.y1 = h, b[g].lineCoordinates.y2 = h, 'inside' === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.y1 = h - y[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)), b[g].bounds = {
            x1: l,
            y1: k + (b[g].margin + F),
            x2: m,
            y2: h,
          ...
          if (a && 0 < a.length) for (g = 0; g < a.length; g++) {
            ...
            if (c && 0 < c.length) for (M = 0; M < c.length; M++) c[M] && c[M].labelAutoFit && (m = 0 > c[M].labelAngle ? Math.max(m, x) : 0 === c[M].labelAngle ? Math.max(m, x / 2) : m, l = 0 > c[M].labelAngle || 0 === c[M].labelAngle ? m - X : l);
    ...
    D.prototype.renderLabelsTicksAndTitle = function () {
      ...
      if ('undefined' === typeof this.options.interval) {
        if ('bottom' === this._position || 'top' === this._position) if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
          for (var c = [
          ], e = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, l, k = this.viewportMaximum, m = this.lineCoordinates.width / Math.log(this.range), h = this._labels.length -
          1; 0 <= h; h--) {
            n = this._labels[h];
          ...
          for (h = 0; h < this._labels.length; h++) n = this._labels[h],
        ...
        if ('left' === this._position || 'right' === this._position) if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
          for (var c = [
          ], p, k = this.viewportMaximum, m = this.lineCoordinates.height / Math.log(this.range), h = this._labels.length - 1; 0 <= h; h--) {
            n = this._labels[h];
            if (n.position < this.viewportMinimum) break;
            n.position > this.viewportMaximum || !(h === this._labels.length - 1 || p < Math.log(k / n.position) * m) || (c.push(n), k = n.position, p = n.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
          }
          this._labels = c
        } else {
          for (h = 0; h < this._labels.length; h++) n = this._labels[h],
      ...
      if ('bottom' === this._position) {
        ...
        0), this.ctx.lineTo(b, q.y + this.tickLength << 0), this.ctx.stroke()), d && 0 !== f++ % 2 && this.labelAutoFit || (0 === n.textBlock.angle ? (q.x -= n.textBlock.width / 2, q.y = 'inside' === this.labelPlacement ? q.y - (('inside' === this.tickPlacement ? this.tickLength : 0) + n.textBlock.height - n.textBlock.fontSize / 2) : q.y + ('inside' === this.tickPlacement ? 0 : this.tickLength) + n.textBlock.fontSize / 2 + 5) : (q.x = 'inside' === this.labelPlacement ? 0 > this.labelAngle ? q.x : q.x - n.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : q.x - (0 > this.labelAngle ? n.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0), q.y = 'inside' === this.labelPlacement ? 0 > this.labelAngle ? q.y - ('inside' === this.tickPlacement ? this.tickLength : 0) - 5 : q.y - ('inside' === this.tickPlacement ? 0 : this.tickLength) - Math.abs(n.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) + 5) : q.y + ('inside' === this.tickPlacement ? 0 : this.tickLength) + Math.abs(0 > this.labelAngle ? n.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) - 5 : 5)), n.textBlock.x = q.x, n.textBlock.y = q.y));
        ...
        for (h = 0; h < this._labels.length; h++) n = this._labels[h],
        n.position < this.viewportMinimum || n.position > this.viewportMaximum || (q = this.getPixelCoordinatesOnAxis(n.position), this.tickThickness && 'inside' != this.tickPlacement && (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor, b = 1 === this.ctx.lineWidth % 2 ? (q.x << 0) + 0.5 : q.x << 0, this.ctx.beginPath(), this.ctx.moveTo(b, q.y << 0), this.ctx.lineTo(b, q.y - this.tickLength << 0), this.ctx.stroke()), d && 0 !== f++ % 2 && this.labelAutoFit || (0 === n.textBlock.angle ? (q.x -= n.textBlock.width / 2, q.y = 'inside' === this.labelPlacement ? q.y + this.labelFontSize / 2 + ('inside' === this.tickPlacement ? this.tickLength : 0) + 5 : q.y - (('inside' === this.tickPlacement ? 0 : this.tickLength) + n.textBlock.height - n.textBlock.fontSize / 2)) : (q.x = 'inside' === this.labelPlacement ? 0 <
      ...
      if ('inside' === this.labelPlacement) this.chart.addEventListener('dataAnimationEnd', function () {
        for (h = 0; h < a._labels.length; h++) n = a._labels[h],
        n.position < a.viewportMinimum || (n.position > a.viewportMaximum || d && 0 !== f++ % 2 && a.labelAutoFit) || (a.ctx.save(), a.ctx.beginPath(), n.textBlock.render(!0), a.ctx.restore())
      }, this);
       else for (h = 0; h < this._labels.length; h++) n = this._labels[h],
      n.position < this.viewportMinimum || (n.position > this.viewportMaximum || d && 0 !== f++ % 2 && this.labelAutoFit) || n.textBlock.render(!0)
    };
    ...
    D.prototype.renderStripLinesOfThicknessType = function (a) {
      if (this.stripLines && 0 < this.stripLines.length && a) {
        for (var d = this, c, b = 0, e = 0, f = !1, l = !1, k = [
        ], m = [
        ...
        for (b = 0; b < this._stripLineLabels.length; b++) if (h = this.stripLines[b], c = this._stripLineLabels[b], !(c.position < this.viewportMinimum || c.position > this.viewportMaximum || isNaN(this.range))) {
          ...
          } else 'top' === this._position ? (p = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, this.ctx.beginPath(), this.ctx.moveTo(p, a.y << 0), this.ctx.lineTo(p, a.y - this.tickLength << 0), this.ctx.stroke(), 0 === this.labelAngle ? (a.x -= c.textBlock.width / 2, a.y -= this.tickLength + c.textBlock.height) : (a.x += (c.textBlock.height - this.tickLength - this.labelFontSize / 2) * Math.sin(Math.PI / 180 * this.labelAngle) - (0 < this.labelAngle ? c.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0), a.y -= this.tickLength + (c.textBlock.height * Math.cos(Math.PI / 180 * this.labelAngle) + (0 < this.labelAngle ? c.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) : 0)))) : 'left' === this._position ? (p = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0, this.ctx.beginPath(), this.ctx.moveTo(a.x << 0, p), this.ctx.lineTo(a.x - this.tickLength << 0, p), this.ctx.stroke(), 0 === this.labelAngle ? a.x = a.x - c.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) - this.tickLength - 5 : (a.y -= c.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle), a.x = 0 < this.labelAngle ? a.x - c.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) - this.tickLength - 5 : a.x - c.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) + (c.textBlock.height - c.textBlock.fontSize / 2 - 5) * Math.sin(Math.PI / 180 * this.labelAngle) - this.tickLength)) : 'right' === this._position && (p = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0, this.ctx.beginPath(), this.ctx.moveTo(a.x << 0, p), this.ctx.lineTo(a.x + this.tickLength << 0, p), this.ctx.stroke(), 0 === this.labelAngle ? a.x = a.x + this.tickLength + 5 : (a.y = 0 > this.labelAngle ? a.y : a.y - (c.textBlock.height - c.textBlock.fontSize / 2 - 5) * Math.cos(Math.PI / 180 * this.labelAngle), a.x = 0 < this.labelAngle ? a.x + (c.textBlock.height - c.textBlock.fontSize / 2 - 5) * Math.sin(Math.PI / 180 * this.labelAngle) + this.tickLength : a.x + this.tickLength + 5));
        ...
        if (!l) {
          ...
          this.ctx.clip();
          for (b = 0; b < k.length; b++) h = k[b],
          h.showOnTop ? f || (f = !0, this.chart.addEventListener('dataAnimationIterationEnd', function () {
            this.ctx.save();
            this.ctx.beginPath();
            this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height);
            this.ctx.clip();
            for (e = 0; e < k.length; e++) h = k[e],
    ...
    D.prototype.renderAxisLine = function () {
      ...
      if ('bottom' === this._position || 'top' === this._position) {
        if (this.lineThickness) {
          ...
          if (this.scaleBreaks && !r(this.scaleBreaks.firstBreakIndex)) if (r(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + b;
           else for (var k = this.scaleBreaks.firstBreakIndex; k <= this.scaleBreaks.lastBreakIndex; k++) d.moveTo(e, l),
          d.lineTo(this.scaleBreaks._appliedBreaks[k].startPixel + c, l),
        ...
        if (this.scaleBreaks && !r(this.scaleBreaks.firstBreakIndex)) if (r(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + c;
         else for (k = this.scaleBreaks.firstBreakIndex; k <= this.scaleBreaks.lastBreakIndex; k++) d.moveTo(l, e),
      ...
      s && (a.drawImage(this.chart._preRenderCanvas, 0, 0, this.chart.width, this.chart.height), this.chart._breaksCanvasCtx && this.chart._breaksCanvasCtx.drawImage(this.chart._preRenderCanvas, 0, 0, this.chart.width, this.chart.height), d.clearRect(0, 0, this.chart.width, this.chart.height));
      d.restore()
    };
    ...
    D.prototype.calculateAxisParameters = function () {
      if (this.logarithmic) this.calculateLogarithmicAxisParameters();
        ...
        null === this.minimum && (this.minimum = 'axisX' === this.type ? e - l / 2 : Math.floor(e / this.interval) * this.interval, this.minimum = Math.min(this.minimum, null === this.sessionVariables.viewportMinimum || isNaN(this.sessionVariables.viewportMinimum) ?
        Infinity : this.sessionVariables.viewportMinimum)),
    ...
    V.prototype.render = function (a) {
      if (0 !== this.spacing || 0 !== this.options.lineThickness && ('undefined' !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
        ...
        n / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, k = this.chart.plotArea.y1 - n / 2 + 0.5 << 0, a *= - 1), this.bounds = {
          ...
          x2: l + n / 2,
          y2: k
        }, this.ctx.moveTo(b, e), 'straight' === this.type || 'top' === this.scaleBreaks.parent._position && 0 >= a || 'bottom' === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(b, k),
        this.ctx.lineTo(l, k),
        this.ctx.lineTo(l, e);
          ...
          f = 0.5;
          p = (k - h) / a / 3;
          for (var q = 0; q < p; q++) this.ctx.bezierCurveTo(m + f * a, h + a, m + f * a, h + 2 * a, m, h + 3 * a),
          h += 3 * a,
          f *= - 1;
          ...
          f *= - 1;
          this.ctx.lineTo(m, h);
          for (q = 0; q < p; q++) this.ctx.bezierCurveTo(m + f * a, h - a, m + f * a, h - 2 * a, m, h - 3 * a),
          h -= 3 * a,
          f *= - 1
        } else {
          if ('zigzag' === this.type) {
            ...
            m = b + a;
            p = (k - h) / a / 2;
            for (q = 0; q < p; q++) this.ctx.lineTo(m, h),
            m += 2 * f * a,
            h += 2 * a,
            f *= - 1;
            this.ctx.lineTo(m, h);
            m += l - b;
            for (q = 0; q < p + 1; q++) this.ctx.lineTo(m, h),
            m += 2 * f * a,
            h -= 2 * a,
            f *= - 1;
        ...
        this.ctx.lineTo(b, k);
          ...
          f = 0.5;
          p = (l - m) / a / 3;
          for (q = 0; q < p; q++) this.ctx.bezierCurveTo(m + a, h + f * a, m + 2 * a, h + f * a, m + 3 * a, h),
          m += 3 * a,
          f *= - 1;
    ...
    N.prototype.render = function () {
      ...
      if (0 < d) {
        ...
        if ('bottom' === this.parent._position || 'top' === this.parent._position) e = f = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0,
        ...
        this.bounds = {
         ...
         else if ('left' === this.parent._position || 'right' === this.parent._position) l = k = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0,
    ...
    ba.prototype.showAt = function (a) {
      ...
      d.axisY2[b].crosshair && (d.axisY2[b].crosshair.enabled && !r(a) && d._crosshairY2Value >= d.axisY2[b].viewportMinimum && d._crosshairY2Value <= d.axisY2[b].viewportMaximum) && (d.axisY2[b].showCrosshair(a), d.axisY2[b].crosshair._updatedValue = a, this === d.axisY2[b].crosshair && (c = !0));
    ...
    ba.prototype.render = function (a, d, c) {
      ...
      if (this.snapToDataPoint) {
        ...
        if ('xySwapped' === this.chart.plotInfo.axisPlacement) {
          ...
          for (var w = 0; w < this.parent.dataSeries.length; w++) (v = this.parent.dataSeries[w].getDataPointAtX(s, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[w], null !== v.dataPoint.y && v.dataSeries.visible && p.push(v));
          v = null;
          ...
          w = 0;
          if ('rangeBar' === p[0].dataSeries.type || 'error' === p[0].dataSeries.type) for (var v = Math.abs(a - this.parent.convertValueToPixel(p[w].dataPoint.y[0])), t = 0, s = 0; s < p.length; s++) if (p[s].dataPoint.y && p[s].dataPoint.y.length) for (var x = 0; x < p[s].dataPoint.y.length; x++) t = Math.abs(a - this.parent.convertValueToPixel(p[s].dataPoint.y[x])),
          t < v && (v = t, w = s);
           else t = Math.abs(a - this.parent.convertValueToPixel(p[s].dataPoint.y)),
          t < v && (v = t, w = s);
           else if ('stackedBar' === p[0].dataSeries.type) for (var v = Math.abs(a - this.parent.convertValueToPixel(p[0].dataPoint.y)), C = t = 0, s = w = 0; s < p.length; s++) if (p[s].dataPoint.y && p[s].dataPoint.y.length) for (x = 0; x < p[s].dataPoint.y.length; x++) t = Math.abs(a - this.parent.convertValueToPixel(p[s].dataPoint.y[x])),
          t < v && (v = t, w = s);
           else C += p[s].dataPoint.y,
          t = Math.abs(a - this.parent.convertValueToPixel(C)),
          t < v && (v = t, w = s);
           else if ('stackedBar100' === p[0].dataSeries.type) for (var v = Math.abs(a - this.parent.convertValueToPixel(p[0].dataPoint.y)), E = C = t = 0, s = 0; s < p.length; s++) if (p[s].dataPoint.y && p[s].dataPoint.y.length) for (x = 0; x < p[s].dataPoint.y.length; x++) t = Math.abs(a - this.parent.convertValueToPixel(p[s].dataPoint.y[x])),
          t < v && (v = t, w = s);
           else C += p[s].dataPoint.y,
          ...
          t < v && (v = t, w = s);
           else for (v = Math.abs(a - this.parent.convertValueToPixel(p[0].dataPoint.y)), s = w = t = 0; s < p.length; s++) if (p[s].dataPoint.y && p[s].dataPoint.y.length) for (x = 0; x < p[s].dataPoint.y.length; x++) t = Math.abs(a - this.parent.convertValueToPixel(p[s].dataPoint.y[x])),
          t < v && (v = t, w = s);
           else t = Math.abs(a - this.parent.convertValueToPixel(p[s].dataPoint.y)),
          t < v && (v = t, w = s);
          x = p[w];
          if ('bottom' === this.parent._position || 'top' === this.parent._position) {
            ...
            if ('rangeBar' === this.parent.dataSeries[w].type || 'error' === this.parent.dataSeries[w].type) {
              ...
              for (s = t = 0; s < x.dataPoint.y.length; s++) t = Math.abs(a - this.parent.convertValueToPixel(x.dataPoint.y[s])),
              t < v && (v = t, b = s);
            ...
            this.parent.dataSeries[w].type) {
              v = Math.abs(a - this.parent.convertValueToPixel(p[0].dataPoint.y));
              C = t = 0;
              for (s = w; 0 <= s; s--) C += p[s].dataPoint.y,
              t = Math.abs(a - this.parent.convertValueToPixel(C)),
              t < v && (v = t, b = s);
            ...
            } else k = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.y) << 0,
            h.text = this.labelFormatter ? this.labelFormatter({
              chart: this.chart,
              axis: this.parent.options,
              crosshair: this.options,
            ...
            E = !1;
            if (this.parent.labels) for (p = Math.ceil(this.parent.interval), s = 0; s < this.parent.viewportMaximum; s += p) if (this.parent.labels[s]) E = !0;
             else {
              E = !1;
              break
            }
          ...
          w = 0;
          if ('rangeColumn' === p[0].dataSeries.type || 'rangeArea' === p[0].dataSeries.type || 'error' === p[0].dataSeries.type || 'rangeSplineArea' === p[0].dataSeries.type || 'candlestick' === p[0].dataSeries.type || 'ohlc' === p[0].dataSeries.type || 'boxAndWhisker' === p[0].dataSeries.type) for (v = Math.abs(d - this.parent.convertValueToPixel(p[0].dataPoint.y[0])), s = t = 0; s < p.length; s++) if (p[s].dataPoint.y && p[s].dataPoint.y.length) for (x = 0; x < p[s].dataPoint.y.length; x++) t = Math.abs(d - this.parent.convertValueToPixel(p[s].dataPoint.y[x])),
          t < v && (v = t, w = s);
           else t = Math.abs(d - this.parent.convertValueToPixel(p[s].dataPoint.y)),
          t < v && (v = t, w = s);
           else if ('stackedColumn' === p[0].dataSeries.type || 'stackedArea' === p[0].dataSeries.type) for (v = Math.abs(d - this.parent.convertValueToPixel(p[0].dataPoint.y)), s = C = t = 0; s < p.length; s++) if (p[s].dataPoint.y && p[s].dataPoint.y.length) for (x = 0; x <
          p[s].dataPoint.y.length; x++) t = Math.abs(d - this.parent.convertValueToPixel(p[s].dataPoint.y[x])),
          t < v && (v = t, w = s);
           else C += p[s].dataPoint.y,
          t = Math.abs(d - this.parent.convertValueToPixel(C)),
          t < v && (v = t, w = s);
           else if ('stackedColumn100' === p[0].dataSeries.type || 'stackedArea100' === p[0].dataSeries.type) for (v = Math.abs(d - this.parent.convertValueToPixel(p[0].dataPoint.y)), s = E = C = t = 0; s < p.length; s++) if (p[s].dataPoint.y && p[s].dataPoint.y.length) for (x = 0; x < p[s].dataPoint.y.length; x++) t = Math.abs(d - this.parent.convertValueToPixel(p[s].dataPoint.y[x])),
          t < v && (v = t, w = s);
           else C += p[s].dataPoint.y,
          E = p[s].dataPoint.x.getTime ? p[s].dataPoint.x.getTime() : p[s].dataPoint.x,
          E = 100 * (C / p[s].dataSeries.plotUnit.dataPointYSums[E]),
          ...
          t < v && (v = t, w = s);
           else for (v = Math.abs(d - this.parent.convertValueToPixel(p[0].dataPoint.y)), s = t = 0; s < p.length; s++) if (p[s].dataPoint.y && p[s].dataPoint.y.length) for (x = 0; x < p[s].dataPoint.y.length; x++) t = Math.abs(d - this.parent.convertValueToPixel(p[s].dataPoint.y[x])),
          t < v && (v = t, w = s);
           else t = Math.abs(d -
          this.parent.convertValueToPixel(p[s].dataPoint.y)),
          t < v && (v = t, w = s);
          x = p[w];
          b = 0;
          if ('rangeColumn' === this.parent.dataSeries[w].type || 'rangeArea' === this.parent.dataSeries[w].type || 'error' === this.parent.dataSeries[w].type || 'rangeSplineArea' === this.parent.dataSeries[w].type || 'candlestick' === this.parent.dataSeries[w].type || 'ohlc' === this.parent.dataSeries[w].type || 'boxAndWhisker' === this.parent.dataSeries[w].type) {
            ...
            for (s = t = 0; s < x.dataPoint.y.length; s++) t = Math.abs(d - this.parent.convertValueToPixel(x.dataPoint.y[s])),
            t < v && (v = t, b = s);
        ...
        p = null;
        if ('bottom' === this.parent._position || 'top' === this.parent._position) 'top' === this.parent._position && h.y - h.fontSize / 2 < this.chart.bounds.y1 && (h.y = this.chart.bounds.y1 + h.fontSize / 2),
        'bottom' === this.parent._position && this.parent.lineCoordinates.y2 -
        h.fontSize / 2 + h.measureText().height > this.chart.bounds.y2 && (h.y = this.chart.bounds.y2 - h.height + h.fontSize / 2 + 2),
        ...
        if ('left' ===
        this.parent._position || 'right' === this.parent._position) 'left' === this.parent._position && h.x < this.chart.bounds.x1 && (h.x = this.chart.bounds.x1),
        'right' === this.parent._position && h.x + h.measureText().width > this.chart.bounds.x2 && (h.x = this.chart.bounds.x2 - h.measureText().width),
        l >= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMinimum : this.parent.viewportMaximum) && f <= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMaximum : this.parent.viewportMinimum) && (0 <
        ...
        if ('bottom' === this.parent._position || 'top' === this.parent._position) b = e = k = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0,
        f = this.chart.plotArea.y1,
        l = this.chart.plotArea.y2,
        this.bounds = {
          x1: b - n / 2,
         ...
         else if ('left' === this.parent._position || 'right' === this.parent._position) f = l = m = 1 === q.lineWidth % 2 ? (d << 0) + 0.5 : d << 0,
        b = this.chart.plotArea.x1,
        e = this.chart.plotArea.x2,
        this.bounds = {
          x1: b,
        ...
        h.y = d + h.fontSize / 2 - h.measureText().height / 2 + 2,
        h.y - h.fontSize / 2 < this.chart.bounds.y1 ? h.y = this.chart.bounds.y1 + h.fontSize / 2 + 2 : h.y + h.measureText().height - h.fontSize / 2 > this.chart.bounds.y2 && (h.y = this.chart.bounds.y2 -
        h.measureText().height + h.fontSize / 2),
        'left' === this.parent._position ? h.x = this.parent.lineCoordinates.x2 - h.measureText().width : 'right' === this.parent._position && (h.x = this.parent.lineCoordinates.x2);
      ...
      if (!this.chart.disableToolTip) {
        ...
        if (this.shared && this.enabled && 'none' !== this.chart.plotInfo.axisPlacement) {
          if ('xySwapped' === this.chart.plotInfo.axisPlacement) {
            ...
            if (this.chart.axisX) for (m = 0; m < this.chart.axisX.length; m++) for (l = this.chart.axisX[m].convertPixelToValue({
              x: a
            }), h = null, b = 0; b < this.chart.axisX[m].dataSeries.length; b++) (h = this.chart.axisX[m].dataSeries[b].getDataPointAtX(l, c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX[m].dataSeries[b], null !== h.dataPoint.y && k.push(h));
          ...
          if (h = this.chart.getDataPointAtXY(a, d, c)) this.currentDataPointIndex = h.dataPointIndex,
          this.currentSeriesIndex = h.dataSeries.index;
           else if (s) if (h = Ya(a, d, this.chart._eventManager.ghostCtx), 0 < h && 'undefined' !== typeof this.chart._eventManager.objectMap[h]) {
          ...
          if (this.enabled) {
            ...
            if (null !== p) {
              ...
              try {
                ...
                this.contentDiv.style.borderRadius = this.cornerRadius || 0 === this.cornerRadius ?
                this.cornerRadius + 'px' : '5px',
                this.container.style.borderRadius = this.contentDiv.style.borderRadius,
                ...
                this.contentDiv.style.fontStyle = this.fontStyle ? this.fontStyle : s ? 'italic' :
                'normal'
              } catch (n) {
              }
    ...
    aa.prototype.highlightObjects = function (a) {
      ...
      for (c = 0; c < a.length; c++) {
        ...
        if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && 'dataPoint' === e.objectType) {
          ...
          b.type || 'stackedBar100' === b.type || 'rangeColumn' === b.type || 'waterfall' === b.type ? da(d, e.x1, e.y1, e.x2, e.y2, 'white', 0, null, !1, !1, !1, !1, 0.3) : 'pie' === b.type || 'doughnut' === b.type ? Z(d, e.center, e.radius, 'white', b.type, e.startAngle, e.endAngle, 0.3, e.percentInnerRadius) : 'funnel' === b.type || 'pyramid' === b.type ? qa(d, e.funnelSection, 0.3, 'white') : 'candlestick' === b.type ? (d.globalAlpha = 1, d.strokeStyle = e.color, d.lineWidth = 2 * e.borderThickness, b = 0 === d.lineWidth % 2 ? 0 : 0.5, d.beginPath(), d.moveTo(e.x3 - b, Math.min(e.y2, e.y3)), d.lineTo(e.x3 - b, Math.min(e.y1, e.y4)), d.stroke(), d.beginPath(), d.moveTo(e.x3 - b, Math.max(e.y1, e.y4)), d.lineTo(e.x3 - b, Math.max(e.y2, e.y3)), d.stroke(), da(d, e.x1, Math.min(e.y1, e.y4), e.x2, Math.max(e.y1, e.y4), 'transparent', 2 * e.borderThickness, e.color, !1, !1, !1, !1), d.globalAlpha = 1) : 'ohlc' === b.type ? (d.globalAlpha = 1, d.strokeStyle = e.color, d.lineWidth = 2 * e.borderThickness, b = 0 === d.lineWidth % 2 ? 0 : 0.5, d.beginPath(), d.moveTo(e.x3 - b, e.y2), d.lineTo(e.x3 - b, e.y3), d.stroke(), d.beginPath(), d.moveTo(e.x3, e.y1), d.lineTo(e.x1, e.y1), d.stroke(), d.beginPath(), d.moveTo(e.x3, e.y4), d.lineTo(e.x2, e.y4), d.stroke(), d.globalAlpha = 1) : 'boxAndWhisker' === b.type ? (d.save(), d.globalAlpha = 1, d.strokeStyle = e.stemColor, d.lineWidth = 2 * e.stemThickness, 0 < e.stemThickness && (d.beginPath(), d.moveTo(e.x3, e.y2 + e.borderThickness / 2), d.lineTo(e.x3, e.y1 + e.whiskerThickness / 2), d.stroke(), d.beginPath(), d.moveTo(e.x3, e.y4 - e.whiskerThickness / 2), d.lineTo(e.x3, e.y3 - e.borderThickness / 2), d.stroke()), d.beginPath(), da(d, e.x1 - e.borderThickness / 2, Math.max(e.y2 + e.borderThickness / 2, e.y3 + e.borderThickness / 2), e.x2 + e.borderThickness / 2, Math.min(e.y2 - e.borderThickness / 2, e.y3 - e.borderThickness / 2), 'transparent', e.borderThickness, e.color, !1, !1, !1, !1), d.globalAlpha = 1, d.strokeStyle = e.whiskerColor, d.lineWidth = 2 * e.whiskerThickness, 0 < e.whiskerThickness && (d.beginPath(), d.moveTo(Math.floor(e.x3 - e.whiskerLength / 2), e.y4), d.lineTo(Math.ceil(e.x3 + e.whiskerLength / 2), e.y4), d.stroke(), d.beginPath(), d.moveTo(Math.floor(e.x3 - e.whiskerLength / 2), e.y1), d.lineTo(Math.ceil(e.x3 + e.whiskerLength / 2), e.y1), d.stroke()), d.globalAlpha = 1, d.strokeStyle = e.lineColor, d.lineWidth = 2 * e.lineThickness, 0 < e.lineThickness && (d.beginPath(), d.moveTo(e.x1, e.y5), d.lineTo(e.x2, e.y5), d.stroke()), d.restore(), d.globalAlpha = 1) : 'error' === b.type && w(d, e.x1, e.y1, e.x2, e.y2, 'white', e.whiskerProperties, e.stemProperties, e.isXYSwapped, 0.3))
        }
      }
      d.restore();
      d.globalAlpha = 1;
    ...
    aa.prototype.getToolTipInnerHTML = function (a) {
      ...
      d = this.contentFormatter ? this.contentFormatter(a) : this.content(a);
        ...
        for (var m = null, h = '', k = 0; k < a.length; k++) c = a[k].dataSeries,
        b = a[k].dataPoint,
        e = a[k].index,
        f = '',
        0 === k && (l && !this.content) && (this.chart.axisX && 0 < this.chart.axisX.length ? h += 'undefined' !== typeof this.chart.axisX[0].labels[b.x] ?
        this.chart.axisX[0].labels[b.x] : '{x}' : this.chart.axisX2 && 0 < this.chart.axisX2.length && (h += 'undefined' !== typeof this.chart.axisX2[0].labels[b.x] ? this.chart.axisX2[0].labels[b.x] : '{x}'), h += '</br>', h = this.chart.replaceKeywordsWithValue(h, b, c, e)),
        null === b.toolTipContent || 'undefined' === typeof b.toolTipContent && null === c.options.toolTipContent || ('line' === c.type || 'stepLine' === c.type || 'spline' === c.type || 'area' === c.type || 'stepArea' === c.type || 'splineArea' === c.type || 'column' === c.type || 'bar' === c.type || 'scatter' ===
    ...
    aa.prototype.showAtX = function (a, d) {
      ...
      (b = c.getDataPointAtX(a, !1)) && (b.dataPoint && !r(b.dataPoint.y) && c.visible) && (b.dataSeries = c, f.push(b));
      if (0 < f.length) {
        for (l = 0; l < f.length; l++) if (b = f[l], b.dataPoint.x < b.dataSeries.axisX.viewportMinimum || b.dataPoint.x > b.dataSeries.axisX.viewportMaximum || b.dataPoint.y < b.dataSeries.axisY.viewportMinimum || b.dataPoint.y > b.dataSeries.axisY.viewportMaximum) e = !0;
         else {
          e = !1;
          break
        }
